...
(function($) {
	...
	*/
	...
	function updateWindow() {
		...
		if(developmentLog){
			console.log("HE.win {width:" + HE.win.width + ", height: " + HE.win.height + ", dirX:" + HE.win.dirX + ", dirY:" + HE.win.dirY + "}");
			console.log("HE.doc {width:" + HE.doc.width + ", height:" + HE.doc.height + "}");
			if(!firstRun){console.log("HE.win [dirX:" + HE.win.dirX + ", dirY:" + HE.win.dirY + "]"); }
		}

		if(developmentElement){
			$("#HE .window").text("HE.win {width:" + HE.win.width + ", height: " + HE.win.height + ", dirX:" + HE.win.dirX + ", dirY:" + HE.win.dirY + "}");
			$("#HE .document").text("HE.doc {width:" + HE.doc.width + ", height:" + HE.doc.height + "}");
		}
	...
	function updateMouse() {
		//Help for development
		if (developmentLog) {console.log("HE.mouse {x:" + HE.mouse.x, ", y:" + HE.mouse.y, ", dirX:" + HE.mouse.dirX, ", dirY:" + HE.mouse.dirY, ", docX:" + HE.mouse.docX, ", docY:" + HE.mouse.docY + "}");}
		if(developmentElement){$("#HE .mouse").text("HE.mouse {x:" + HE.mouse.x + ", y:"+HE.mouse.y+", dirX:" + HE.mouse.dirX + ", dirY:" + HE.mouse.dirY + ", docX:" + HE.mouse.docX + ", docY:" + HE.mouse.docY + ", target:" + HE.mouse.target + "}");}
